...
export class HomeComponent {
  public icons = {
    mood_1: "src/img/mood-1.svg",
    mood_2: "src/img/mood-2.svg",
    mood_3: "src/img/mood-3.svg",
    mood_4: "src/img/mood-4.svg",
    mood_5: "src/img/mood-5.svg",
    steps:"src/img/running.svg",
    heart_tile : "src/img/heart-tile.svg",
    heart_day : "src/img/heart-day.svg",
    bed : "src/img/bed.svg",
    moon_tile : "src/img/moon-tile.svg",
    moon_day : "src/img/moon-day.svg",
    sun : "src/img/sun.svg",
    flame :"src/img/flame.svg",
    soccer : "src/img/soccer.svg",
    dumbbell : "src/img/dumbbell.svg",
    bike : "src/img/bicycle.svg",
    clock : "src/img/clock.svg",
    burn : "src/img/burn.svg",
    desk : "src/img/desk.svg",
    mood : "src/img/sleeping.svg",
    tennis : "src/img/tennis.svg",
  };
